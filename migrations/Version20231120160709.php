 ...
 */
final class Version20231120160709 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cars (id INT AUTO_INCREMENT NOT NULL, carburant_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, year DOUBLE PRECISION NOT NULL, kilometrage DOUBLE PRECISION NOT NULL, description LONGTEXT NOT NULL, illustration VARCHAR(255) NOT NULL, INDEX IDX_95C71D1432DAAD24 (carburant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
